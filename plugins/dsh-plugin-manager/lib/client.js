window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function adoptStyle() {
			...
			style.id = STYLE_ID;
			style.textContent = [
				".pm-root{display:flex;flex-direction:column;gap:12px;padding:6px 2px 24px;font-size:13px;color:var(--dsw-alias-content-primary,#eee);max-width:1100px}",
				...
				".pm-table{border:1px solid var(--dsw-alias-stroke-default,#3a3a3a);border-radius:12px;overflow-x:auto}",
				".pm-table table{width:100%;min-width:680px;border-collapse:collapse;font-size:12px}",
				".pm-table th{text-align:left;padding:8px 12px;background:var(--dsw-alias-surface-sunken,#161617);border-bottom:1px solid var(--dsw-alias-stroke-default,#3a3a3a);font-weight:600;color:var(--dsw-alias-content-secondary,#9b9b9b);white-space:nowrap}",
				...
				".pm-path{color:var(--dsw-alias-content-secondary,#9b9b9b);font-size:11px;white-space:nowrap}",
				".pm-exists-ok{color:var(--dsw-alias-state-success-primary,#7ee2a8);white-space:nowrap}",
				".pm-exists-no{color:var(--dsw-alias-state-error-primary,#ff9b9b);white-space:nowrap}",
				".pm-ops{display:flex;gap:6px;align-items:center;justify-content:flex-end;flex-wrap:nowrap}",
				".pm-act{border:1px solid var(--dsw-alias-stroke-default,#3a3a3a);background:#ffffff0d;color:inherit;border-radius:6px;padding:3px 10px;font-size:11px;cursor:pointer;white-space:nowrap;flex-shrink:0}",
